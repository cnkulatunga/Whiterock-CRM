...
export const AUDIT_LOG_ENTRIES = [
    { id: 1, date: 'Apr 08, 2026', time: '17:22:15', name: 'Jane Doe', initials: 'JD', bg: ROLE_COLORS['Super Admin'].bg, role: 'Super Admin', roleCls: ROLE_COLORS['Super Admin'].roleCls, actionIcon: 'security', actionText: 'Updated system security policy: Multi-factor authentication forced for all admins', refId: 'SYS-SEC-001', status: 'Success', ip: '192.168.1.1' },
    { id: 2, date: 'Apr 08, 2026', time: '16:45:02', name: 'System', initials: 'SYS', bg: '#f1f5f9', role: 'Security Bot', roleCls: 'bg-slate-100 text-slate-600', actionIcon: 'reject', actionText: 'Detected multiple failed login attempts from unknown IP', refId: '103.44.12.1', status: 'Blocked', category: 'Security Alert' },
    { id: 3, date: 'Apr 08, 2026', time: '15:30:11', name: 'Marcus Smith', initials: 'MS', bg: ROLE_COLORS['Team Leader'].bg, role: 'Team Leader', roleCls: ROLE_COLORS['Team Leader'].roleCls, actionIcon: 'edit', actionText: 'Changed password for user: Priya Sharma', refId: 'USER-11', status: 'Success' },
    { id: 4, date: 'Apr 08, 2026', time: '14:24:08', name: 'Jane Doe', initials: 'JD', bg: ROLE_COLORS['Super Admin'].bg, role: 'Super Admin', roleCls: ROLE_COLORS['Super Admin'].roleCls, actionIcon: 'verify', actionText: 'Verified compliance docs for', refId: 'AF-001', status: 'Success' },
    { id: 5, date: 'Apr 08, 2026', time: '13:15:22', name: 'Marcus Smith', initials: 'MS', bg: ROLE_COLORS['Team Leader'].bg, role: 'Team Leader', roleCls: ROLE_COLORS['Team Leader'].roleCls, actionIcon: 'verify', actionText: 'Approved bank statements for', refId: 'AF-011', status: 'Success' },
    { id: 6, date: 'Apr 08, 2026', time: '11:05:44', name: 'Sarah White', initials: 'SW', bg: ROLE_COLORS['Accounts Manager'].bg, role: 'Accounts Manager', roleCls: ROLE_COLORS['Accounts Manager'].roleCls, actionIcon: 'verify', actionText: 'Approved final loan terms for', refId: 'AF-008', status: 'Success', turnover: '£750,000' },
    { id: 7, date: 'Apr 08, 2026', time: '10:12:12', name: 'Sarah White', initials: 'SW', bg: ROLE_COLORS['Accounts Manager'].bg, role: 'Accounts Manager', roleCls: ROLE_COLORS['Accounts Manager'].roleCls, actionIcon: 'verify', actionText: 'Submitted file to ANZ Bank for', refId: 'AF-002', status: 'Success' },
    { id: 8, date: 'Apr 07, 2026', time: '17:30:00', name: 'Marcus Smith', initials: 'MS', bg: ROLE_COLORS['Team Leader'].bg, role: 'Team Leader', roleCls: ROLE_COLORS['Team Leader'].roleCls, actionIcon: 'reject', actionText: 'Rejected incomplete ID docs for', refId: 'AF-004', status: 'Rejected', note: 'Unclear photo' },
    { id: 9, date: 'Apr 07, 2026', time: '09:20:15', name: 'System', initials: 'SYS', bg: '#f1f5f9', role: 'System', roleCls: 'bg-slate-100 text-slate-600', actionIcon: 'auto', actionText: 'Automatically archived 24 inactive leads older than 90 days', refId: 'AUTO-ARCHIVE', status: 'Success' },
    { id: 10, date: 'Apr 06, 2026', time: '11:15:22', name: 'Jane Doe', initials: 'JD', bg: ROLE_COLORS['Super Admin'].bg, role: 'Super Admin', roleCls: ROLE_COLORS['Super Admin'].roleCls, actionIcon: 'security', actionText: 'Exported full lead database (CSV)', refId: 'DB-EXPORT-042', status: 'Warning', category: 'Data Privacy' },
];

/**
 * Knowledge Base Resources
 */
export const KNOWLEDGE_BASE_RESOURCES = [
    ...
    { id: 5, category: 'Audit', name: 'Compliance Monitoring Protocol', type: 'PDF', size: '1.2 MB', tag: 'teal', content: 'Audit procedures for every lead:\n1. Verify ID match against bank statements\n2. Check Companies House for active status\n3. Match business address with utility bills\n4. Flag multiple applications from same IP\n5. Monitor role-based access logs daily' },
];
