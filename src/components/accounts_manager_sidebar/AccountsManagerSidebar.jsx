...
const NAV_GROUPS = [
    {
        ...
        items: [
            ...
            {
                id: 'promotions',
                path: '/accounts-manager/promotions',
    ...
    },
    {
        ...
        items: [
            {
                id: 'lead_performance',
                path: '/accounts-manager/lead-performance',
            ...
            >
                ...
                {!isCollapsed && (
                    <div className="flex flex-col gap-[1px] min-w-0 flex-1 pr-4">
                        ...
                        <span className="text-[0.62rem] font-bold tracking-[1.1px] uppercase" style={{ color: isDark ? '#1d4ed8' : '#93c5fd' }}>Accounts Manager</span>
                    </div>
                )}
