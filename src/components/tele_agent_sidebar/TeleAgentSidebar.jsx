...
const NAV_GROUPS = [
    {
        ...
        items: [
            ...
            { id: 'promotions', path: '/tele-agent/promotions', label: 'Lender Promotions', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" width="18" height="18"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg> },
            // { id: 'leave', path: '/leave-management/login', label: 'Leave', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="18" height="18"><rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg> }, // COMMENTED OUT
        ],
    },
];
            ...
            >
                ...
                {!isCollapsed && (
                    <div className="flex flex-col gap-[1px] min-w-0 flex-1 pr-4">
                        ...
                        <span className="text-[0.62rem] font-bold tracking-[1.1px] uppercase" style={{ color: isDark ? '#1d4ed8' : '#93c5fd' }}>Tele Agent</span>
                    </div>
                )}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {isCollapsed && isComingSoon && (
                                        <div className="absolute top-1 right-1 w-1.5 h-1.5 rounded-full" style={{ background: 'rgba(255,255,255,0.7)' }} />
                                    )}
                                </button>
                            );
                        })}
