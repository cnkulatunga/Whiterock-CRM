...
const AddHolidayModal = ({ onClose, onSave, isDark, addedByName }) => {
    ...
    const handleSave = () => {
        ...
        onSave({ ...form, name: form.name.trim(), addedBy: addedByName, addedByRole: 'team_leader' });
    };
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[999] p-4">
                            ...
                            {holidays.map((h, idx) => (
                                <div key={h.id} className="flex items-center gap-4 px-5 py-4"
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="text-xs mt-0.5 flex items-center gap-2" style={{ color: isDark ? '#8ea0d4' : '#6b7eb8' }}>
                                            <span>{h.date}</span>
