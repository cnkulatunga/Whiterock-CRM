                ...
                <div className="flex flex-col divide-y divide-[#f7fafc]">
                    {documents.map((doc, idx) => (
                        <React.Fragment key={doc.id}>
                            {/* Row */}
                            <div
                                className={`grid gap-4 px-8 py-4 items-center transition-all duration-200 animate-rowIn ${rejectionOpenId === doc.id ? 'bg-[#fff8f8]' : 'hover:bg-[#f8faff]'}`}
                                style={{
                                    ...
                                    {doc.status === 'Pending' && (
                                        <>
                                            <button
                                                ...
                                                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#2447d7] text-white text-[11px] font-black hover:bg-[#1732a3] transition-all shadow-[0_2px_8px_rgba(36,71,215,0.2)] hover:-translate-y-px"
                                            >
