        ...
        <div className="flex flex-col gap-6 animate-fadeIn font-['Sora',sans-serif]">
            ...
            <header className="flex justify-between items-start gap-4 flex-wrap">
                <div>
                    ...
                    <p className="text-sm text-[#718096]">Detailed analysis of lead acquisition and conversion metrics.</p>
                </div>
            ...
            {/* ── FILTERS ── */}
            <div className="bg-white rounded-2xl border border-[#edf2f7] p-5 shadow-sm grid grid-cols-4 gap-4 lg:grid-cols-2 sm:grid-cols-1">
                {filters.map(f => (
                        ...
                        <tbody className="divide-y divide-[#f7fafc]">
                            {RECENT_LEADS.map(lead => (
                                <tr key={lead.id} className="hover:bg-[#f8faff] transition-colors">
                                    ...
                                    <td className="px-6 py-4"><span className={`text-[10px] font-semibold px-2.5 py-1 rounded-lg uppercase tracking-wider ${lead.stageCls}`}>{lead.stage}</span></td>
                                    <td className="px-6 py-4">
