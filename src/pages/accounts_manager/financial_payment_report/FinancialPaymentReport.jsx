...
import './FinancialPaymentReport.css';
                        ...
                        {BAR_DATA.map((bar) => (
                            <div className="am-fin-bar-col" key={bar.month}>
                                <div className="am-fin-bar-track">
                                    <div className="am-fin-bar-fill" style={{ height: `${bar.value}%` }} />
                                </div>
                    ...
                    <div className="am-fin-donut-wrap">
                        <svg viewBox="0 0 120 120" width="160" height="160">
                            ...
                            <circle cx="60" cy="60" r="45" fill="none" stroke="#ef4444" strokeWidth="18"
                                strokeDasharray="42.4 240" strokeDashoffset="0" transform="rotate(-90 60 60)" />
                            <circle cx="60" cy="60" r="45" fill="none" stroke="#f97316" strokeWidth="18"
                                strokeDasharray="28.3 240" strokeDashoffset="-42.4" transform="rotate(-90 60 60)" />
                            <circle cx="60" cy="60" r="45" fill="none" stroke="#22c55e" strokeWidth="18"
                                strokeDasharray="212.1 240" strokeDashoffset="-70.7" transform="rotate(-90 60 60)" />
                        </svg>
...
export default FinancialPaymentReport;
