        ...
        <div className="relative shrink-0">
            ...
            {isOpen && ReactDOM.createPortal(
                <>
                    ...
                    <div
                        className="fixed z-[200] w-36 rounded-xl border shadow-2xl overflow-hidden animate-fadeIn"
                        style={{ top: dropPos.top, right: dropPos.right, background: isDark ? '#1e2347' : '#ffffff', borderColor: isDark ? '#2c3568' : '#e2e8f0' }}
                    >
                        {options.map(opt => {
                                        ...
                                        <div className="flex-1 min-w-0 overflow-hidden">
                                            <div className="flex items-start justify-between gap-2">
                                                ...
                                                <div className="flex items-center gap-1.5 shrink-0">
                                                    ...
                                                    {task.isOutlook ? (
                                                        <span className={`text-[9px] font-black px-2.5 py-1 rounded-full uppercase tracking-tighter border ${isDark ? 'bg-blue-500/15 text-blue-400 border-blue-500/20' : 'bg-blue-50 text-blue-600 border-blue-100'}`}>Outlook Event</span>
                                                    ) : (
                                            ...
                                            <div className="flex items-center gap-2 mt-1 flex-wrap">
                                                ...
                                                {(() => {
                                                    ...
                                                    const roleCfg = member.role === 'Team Leader'
                                                    ...
                                                    return (
                                                        <span className={`text-[8px] font-black px-1.5 py-0.5 rounded flex items-center gap-1 ${roleCfg}`}>
