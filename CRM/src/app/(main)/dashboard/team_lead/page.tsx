...
export default function TeamLeadDashboard() {
    ...
    const { cardOrder, saveLayout, resetLayout } = useDashboardLayout('team_lead');
    ...
    const renderCard = (key: string) => {
        switch (key) {
            case 'my_team_leads': return canSeeCard(key) ? <TeleAgentLeadsCard title="My Team's Leads" /> : null;
